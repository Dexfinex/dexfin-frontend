        ...
        <Menu>
          ...
          >
            ...
            <MenuItem
              bgColor={'blackAlpha.50'}
              _hover={{ bg: 'whiteAlpha.100' }}
              onClick={() => { setInput('Show market overview') }}
            >
              <Box>
                <Text>Show market overview</Text>
                <Text fontSize="xs" color="gray.500">view market analysis</Text>
              </Box>
            </MenuItem>
            <MenuItem
              bgColor={'blackAlpha.50'}
            ...
            <MenuItem
              bgColor={'blackAlpha.50'}
              _hover={{ bg: 'whiteAlpha.100' }}
              onClick={() => { setInput('Predict BTC price movement') }}
            >
              <Box>
                <Text>Predict BTC price movement</Text>
                <Text fontSize="xs" color="gray.500">Get price prediction for BTC</Text>
              </Box>
            </MenuItem>
            <MenuItem
              bgColor={'blackAlpha.50'}
              ...
              <Menu>
                ...
                >
                  ...
                  <MenuItem
                    bgColor={'blackAlpha.50'}
                    _hover={{ bg: 'whiteAlpha.100' }}
                    onClick={() => { setInput('Show market overview'); onDrawerClose();  }}
                  >
                    <Box>
                      <Text>Show market overview</Text>
                      <Text fontSize="xs" color="gray.500">view market analysis</Text>
                  ...
                  <MenuItem
                    bgColor={'blackAlpha.50'}
                    _hover={{ bg: 'whiteAlpha.100' }}
                    onClick={() => { setInput('Predict BTC price movement'); onDrawerClose();  }}
                  >
                    <Box>
                      <Text>Predict BTC price movement</Text>
                      <Text fontSize="xs" color="gray.500">Get price prediction for BTC</Text>
              ...
              <Menu>
                ...
                >
                  ...
                  <MenuItem
                    bgColor={'blackAlpha.50'}
                    _hover={{ bg: 'whiteAlpha.100' }}
                    onClick={() => { setInput('Buy 0.1 BTC'); onDrawerClose();  }}
                  >
                    <Box>
                      <Text>Buy 0.1 BTC</Text>
                      <Text fontSize="xs" color="gray.500">Purchase Bitcoin</Text>
