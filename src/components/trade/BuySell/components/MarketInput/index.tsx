...
const MarketInput = ({
    ...
    return (
        <div style={{
            ...
            <InputGroup className='relative glass'>
                {
                    hasLeftElement && (
                        <InputLeftElement pointerEvents='none' className='glass'>
                ...
                }
                {
                    hasUnit && (
                        <InputRightElement
                            className="market-input-right-element glass"
                ...
                <StyledInput
                    onFocus={onFocus}
                    disabled={disabled}
                    className={`${hasLeftElement ? "glass" : "normal-input"} glass`}
                    type='number'
                    placeholder=''
                    value={value}
                    onChange={(e) => {
...
export const CustomizedInput = ({
    ...
    return (
        <InputGroup className="glass"
            sx={{
                '&&.glass': {  // Double && increases specificity
                    all: 'unset',
                    display: 'flex'
                }
            }}>
