...
export interface IUniswapV2RouterInterface extends Interface {
    ...
    encodeFunctionData(functionFragment: "swapExactETHForTokensSupportingFeeOnTransferTokens", values: [BigNumberish, AddressLike[], AddressLike, BigNumberish]): string;
...
export interface IUniswapV2Router extends BaseContract {
    ...
    getFunction(nameOrSignature: "removeLiquidityETHSupportingFeeOnTransferTokens"): TypedContractMethod<[
        token: AddressLike,
        liquidity: BigNumberish,
        amountTokenMin: BigNumberish,
        amountETHMin: BigNumberish,
    ...
    getFunction(nameOrSignature: "removeLiquidityETHWithPermit"): TypedContractMethod<[
        token: AddressLike,
        liquidity: BigNumberish,
        amountTokenMin: BigNumberish,
        amountETHMin: BigNumberish,
    ...
    getFunction(nameOrSignature: "removeLiquidityETHWithPermitSupportingFeeOnTransferTokens"): TypedContractMethod<[
        token: AddressLike,
        liquidity: BigNumberish,
        amountTokenMin: BigNumberish,
        amountETHMin: BigNumberish,
    ...
    getFunction(nameOrSignature: "removeLiquidityWithPermit"): TypedContractMethod<[
        tokenA: AddressLike,
        tokenB: AddressLike,
        liquidity: BigNumberish,
        amountAMin: BigNumberish,
    ...
    getFunction(nameOrSignature: "swapExactETHForTokensSupportingFeeOnTransferTokens"): TypedContractMethod<[
        amountOutMin: BigNumberish,
        path: AddressLike[],
        to: AddressLike,
        deadline: BigNumberish
    ...
    getFunction(nameOrSignature: "swapExactTokensForTokensSupportingFeeOnTransferTokens"): TypedContractMethod<[
        amountIn: BigNumberish,
        amountOutMin: BigNumberish,
        path: AddressLike[],
        to: AddressLike,
