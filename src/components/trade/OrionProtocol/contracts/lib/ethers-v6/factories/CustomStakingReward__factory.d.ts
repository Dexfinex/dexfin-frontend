...
import type { CustomStakingReward, CustomStakingRewardInterface } from "../CustomStakingReward.js";
export declare class CustomStakingReward__factory {
    ...
    static createInterface(): CustomStakingRewardInterface;
    static connect(address: string, runner?: ContractRunner | null): CustomStakingReward;
}
