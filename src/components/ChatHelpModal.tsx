    ...
    return (
        <div className="fixed inset-0 z-[60] flex items-center justify-center">
            ...
            <div className="relative w-[340px] md:w-[520px] glass border border-white/10 rounded-xl overflow-hidden">
                ...
                <div className='p-8'>
                    <p className='text-md md:text-xl text-white/90 font-bold mb-4'>Dexfin Chat is a decentralized messaging platform that allows users to communicate securely using their Ethereum addresses.</p>

                    <p className='text-sm md:text-md mt-2 text-white/80'>1. Searching for Users
                    ...
                    <p className='text-sm md:text-md mt-2 text-white/80'>2. Sending a Chat Request
                    ...
                    <p className='text-sm md:text-md mt-2 text-white/80'>3. Receiving and Accepting Requests
                    ...
                    <p className='text-sm md:text-md mt-2 text-white/80'>4. Managing Conversations
                    ...
                    <p className='text-sm md:text-md mt-2 text-white/80'>5. Using Group Chats
