      ...
      <div className="grid grid-cols-4 gap-4 mb-6">
        <div className="bg-white/5 rounded-xl p-4">
          ...
          <div className="mt-1">
            ...
            <div className="text-sm text-orange-400 mt-1">{marketMetrics.fearGreed.label}</div>
          </div>
        </div>
        ...
        <div className="bg-white/5 rounded-xl p-4">
          ...
          <div className="mt-1">
            ...
            <div className="text-sm text-purple-400 mt-1">{marketMetrics.marketSentiment.label}</div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-2 gap-6">
        ...
        <div className="bg-white/5 rounded-xl p-4">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="px-2 py-1 rounded-lg bg-green-500/20 text-green-400 text-sm">
              5.2% ↑
            </div>
          </div>
