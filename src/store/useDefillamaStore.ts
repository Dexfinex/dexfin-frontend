...
//     getDexVolume: () => { dexVoulme: DefillamaDexVolume[] };
// }
...
//     },
//     setChainTVLs: (chainTVLs: DefillamaChainTVL[]) => {
//         set({ chainTVLs })
//     },
//     getDeFiStats: () => {
//         const state = useDefillamaStore.getState() as DefillamaStore;
...
//         // const chainTVLs = state.chainTVLs.map((chainTVL) => ({
//         //     gecko_id: chainTVL.gecko_id,
//         //     tvl: chainTVL.tvl,
//         //     tokenSymbol: chainTVL.tokenSymbol,
//         //     cmcId: chainTVL.cmcId,
//         //     name: chainTVL.name,
//         //     chainId: chainTVL.chainId,
//         // }))
//         // console.log("chainTVLsstore : ", chainTVLs);
//         return {
//             chainTVLs: state.chainTVLs
//         }
//     },
//     getDexVolume: () => {
//         const state = useDefillamaStore.getState() as DefillamaStore;
