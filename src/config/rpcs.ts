...
export const rpcsMap: Record<number, > = Object.entries(rpcUrls).reduce((acc, [chainId, rpcs]) => {
...
export const providers: Record<string, ethers.providers.FallbackProvider> = {
