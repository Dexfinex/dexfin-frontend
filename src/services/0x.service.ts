...
import {gaslessSubmitResponse, QuoteResponse, ZeroxQuoteRequestType} from "../types/swap.type.ts";
...
export const zeroxService = {
    ...
    submitTrade: async (chainId: number, tradeDataToSubmit: any, approvalDataToSubmit: any): Promise<string> => {
        try {
